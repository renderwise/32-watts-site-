...
function mailFormate($to, $subject, $message1, $message2, $title, $heading, $name) {
    ...
    if ($contact_name != '' && $address != '' ) {
        $to = 'nikgupta2701@gmail.com'; //change email address info@alignwisesmile.com
        $name = $contact_name;
...
function mailFormate($to, $subject, $message1, $message2, $title, $heading, $name) {
    ...
    if ($contact_name != '' && $address != '' ) {
        $to = 'narayan@alignwisesmile.com,nikgupta2701@gmail.com'; //change email address info@alignwisesmile.com
        $name = $contact_name;
        $subject = "Enquiry From " . $name;
        $title = "Enquiry From ";
        $heading = "Enquiry From ";
