...
if ($_REQUEST['submitFormContact'] == 'yes') {

    $contact_name = $_POST['contact_name'];
    $mobile = $_POST['contact_phone'];
    $email = $_POST['contact_email'];
    $looking = $_POST['contact_looking_for'];
    $message = $_POST['contact_message'];
    $location = $_POST['contact_location'];

    if ($contact_name != '' && $email != '' && $looking != '' && $location != '') {
        $to = 'info@32watts.com'; //change email address info@alignwisesmile.com
        $name = $contact_name;
                    ...
                    <html xmlns='http://www.w3.org/1999/xhtml'>
                        ...
                        <table width='600'  cellpadding='3' cellspacing='0' style='border-collapse: collapse; border:1px solid;' >
                                <tbody>
                                    ...
                                    <tr><td  valign='top' colspan='3'>Email:- </td><td>$email</td></tr>
                                    <tr><td  valign='top' colspan='3'>Looking For:- </td><td>$looking</td></tr>
                                    <tr><td  valign='top' colspan='3'>Location:- </td><td>$location</td></tr>
                                    <tr><td  valign='top' colspan='3'>Message:- </td><td>$message</td></tr>        
                                </tbody>
                            </table>
                        </body>
                    </html>";
