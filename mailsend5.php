...
if ($_REQUEST['submitFormContact'] == 'yes') {
    ...
    if ($contact_name != '' && $mobile != '' && $location != '') {
        $to = 'info@32watts.com,deepak@32watts.com'; //change email address info@alignwisesmile.com
        $name = $contact_name;
        ...
        $msg1 = "<!DOCTYPE html PUBLIC '-//W3C//DTD XHTML 1.0 Transitional//EN' 'http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd'>
                    <html xmlns='http://www.w3.org/1999/xhtml'>
                        ...
                        <table width='600'  cellpadding='3' cellspacing='0' style='border-collapse: collapse; border:1px solid;' >
                                <tbody>
                                    <tr><td  valign='top' colspan='3'>Pricing Enquiry From  $name</td></tr>
        ...
        header("location: clear-aligners-cost-in-india.html");
    } else {
